...
-- -----------------------------------------------------
-- Table `basic_people`.`BANK_ACCOUNT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `basic_people`.`BANK_ACCOUNT` ;

CREATE TABLE IF NOT EXISTS `basic_people`.`BANK_ACCOUNT` (
